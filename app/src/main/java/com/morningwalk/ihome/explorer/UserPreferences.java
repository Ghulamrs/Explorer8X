...
public class UserPreferences {
    ...
    private float lat  = 30.40f;
    private float lng  = 70.635f;
    ...
    public float getZoom() { return m_sp.getFloat ("zoom", 5.0f); }
    public float getBearing() { return m_sp.getFloat ("bearing", 0.0f); }
    public float getTilt() { return m_sp.getFloat ("tilt", 0.0f); }
